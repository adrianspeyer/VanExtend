...
$PluginInfo['MajorLeague'] = array(
   'Name' => 'Major League Video Embed',
   'Description' => 'Allows users to embed Major League videos in posts.',
   'Version' => '1.0',
   'Author' => "Adrian",
   'License' => 'GNU GPL2',
   'MobileFriendly' => TRUE
...
class MajorLeaguePlugin extends Gdn_Plugin {
   /*
   ...
   private function IncludeAssets($Sender) {
      $Sender->AddCssFile('majorleague.css', 'plugins/MajorLeague');
      $Sender->AddJsFile('majorleague.js', 'plugins/MajorLeague');
   }
